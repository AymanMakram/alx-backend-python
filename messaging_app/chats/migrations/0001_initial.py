# Generated by Django 5.2.8 on 2025-11-15 18:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Conversation',
            fields=[
                ('conversation_id', models.UUIDField(db_column='conversation_id', default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Message',
            fields=[
                ('message_id', models.UUIDField(db_column='message_id', default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
